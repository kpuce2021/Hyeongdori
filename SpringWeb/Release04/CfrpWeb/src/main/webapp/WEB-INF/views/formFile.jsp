...
<html>
	...
	<body>
		      ...
		      <div class="row">
		         ...
		         <div class="col-sm-8">
		            ...
		            <!-- 웹에서 서버로 로컬에 검출 전 이미지를 보내는 부분 -->  
		            	<div align=center>
		            		<form class="form-inline" action="/receive/LocalToServer" enctype="multipart/form-data" method="post" >
		...
		<img src="${pageContext.request.contextPath}/resources/img/001.png"/><br>
