...
public class UserController {
	...
	public void loginPostMethod(HttpSession session, UserVO vo, HttpServletResponse response, Model model) throws Exception{
		...
		if(loginUser == null) {
			ScriptUtils.alertAndMovePage(response, "아이디 및 비밀번호를 확인하세요", "http://3.34.77.179:8080/main-1.0.0-BUILD-SNAPSHOT/main/home");
		}
		else { // 로그인 성공
			session.setAttribute("login", loginUser);
			ScriptUtils.alertAndMovePage(response, "로그인 성공", "http://3.34.77.179:8080/main-1.0.0-BUILD-SNAPSHOT/main/home");
		}
