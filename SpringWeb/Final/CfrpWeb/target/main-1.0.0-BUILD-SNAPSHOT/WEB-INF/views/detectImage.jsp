		...
		<div class="container-fluid">
		      <div class="row">
		         ...
		         <jsp:include page="/WEB-INF/views/sideView/header.jsp"></jsp:include>
					...
					<button onclick="myFunction('Demo1')" class="w3-btn w3-round-large w3-block w3-left-align" style="background-color:#EBEDEF"><i class="glyphicon glyphicon-zoom-in"></i> 검출 전 이미지 : ${img}</button>
					<div id="Demo1" class="w3-container w3-hide">
					  <img src="http://3.34.77.179:8080/upload/${img}" width="700" height="500" alt="no image"/>
					</div>
					<br>
					<button onclick="myFunction('Demo2')" class="w3-btn w3-round-large w3-block w3-left-align" style="background-color:#EBEDEF"><i class="glyphicon glyphicon-zoom-in"></i> 검출 후 이미지 : ${img}</button>
