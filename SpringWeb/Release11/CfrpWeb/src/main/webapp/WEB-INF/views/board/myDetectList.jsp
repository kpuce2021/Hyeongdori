		...
		<div class="container-fluid">
		      <div class="row">
		         ...
		         <br>
		            ...
		            <button onclick="myFunction('Demo1')" class="w3-btn w3-round-large w3-block w3-black w3-left-align"><i class="glyphicon glyphicon-zoom-in"></i>검출 후 이미지 : ${img}</button>
					<div id="Demo1" class="w3-container w3-hide">
					  <img src="http://3.34.77.179:8080/detect/${img}" width="700" height="500" alt="no image"/>
					</div>
					<br>
					<button onclick="myFunction('Demo2')" class="w3-btn w3-round-large w3-block w3-black w3-left-align"><i class="glyphicon glyphicon-zoom-in"></i>검출 전 이미지 : ${img}</button>
